...
{
    #[Route('/formulaire/g', name: 'formulaire_g_index')]
    ...
    #[Route('/formulaire/g/create', name: 'formulaire_g_create', methods: ['GET', 'POST'])]
    ...
    #[Route('/formulaire/g/{id}/delete', name: 'formulaire_g_delete', requirements: ['id' => '\d+'], methods: ['GET'])]
